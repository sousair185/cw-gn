...
function Main(props) {
  ...
  const toggleAccountActivation = useCallback(() => {
    if (pushMessageToSnackbar) {
      if (isAccountActivated) {
        ...
        pushMessageToSnackbar({
          text: "Sua conta agora está ativa.",
        });
      }
    }
  ...
  const selectDashboard = useCallback(() => {
    smoothScrollTop();
    document.title = "Geração Net - Dashboard";
  ...
  const selectPosts = useCallback(() => {
    smoothScrollTop();
    document.title = "Geração Net - Planos";
    setSelectedTab("Planos");
  ...
  const selectSubscription = useCallback(() => {
    smoothScrollTop();
    document.title = "Geração Net - Subscription";
