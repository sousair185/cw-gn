...
const rows = [
  ...
  { id: "number1", numeric: false, label: "Categoria 1" },
  { id: "number2", numeric: false, label: "Categoria 2" },
  { id: "number3", numeric: false, label: "Categoria 3" },
  {
    id: "number4",
    numeric: false,
    label: "Categoria 4",
  ...
  return (
    <Accordion>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <Typography>Dados de usuários</Typography>
      </AccordionSummary>
      <ConfirmationDialog
      ...
      <Box width="100%">
        <div className={classes.tableWrapper}>
          {targets.length > 0 ? (
            ...
            <Box m={2}>
              <HighlightedInformation>Nada adicionado.</HighlightedInformation>
            </Box>
          )}
        </div>
